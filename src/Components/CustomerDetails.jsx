        ...
        return (<div>
            <div className="subMain" style={{height: '600px'}}>
                ...
                <div className='content'>
                    <div className='name'>
                        <TextField id="outlined-basic" label="Name" name="name" value={name}
                                   onChange={this.changeHandler} variant="outlined" style={{width: '100%'}}/>
                    </div>
                ...
                <div className='content'>
                    <div className='name'>
                        <TextField id="outlined-basic" label="Email" name="email" value={email}
                                   onChange={this.changeHandler} variant="outlined" style={{width: '100%'}}/>
                    </div>
                    <div className='phonenumber'>
                        <TextField id="outlined-basic" label="pinCode" name="pinCode" value={pinCode}
                                   onChange={this.changeHandler} variant="outlined" style={{width: '100%'}}/>
                    </div>
                </div>

                <div className='address'>
                    <TextField id="outlined-basic" label="Address" name="address" value={address}
                               onChange={this.changeHandler} variant="outlined" style={{width: '100%'}}/>
                </div>
                <div className='content'>
                    <div className='name'>
                    ...
                    <div className='phonenumber'>
                        <TextField id="outlined-basic" label="Country" name="country" value={country}
                                   onChange={this.changeHandler} variant="outlined" style={{width: '100%'}}/>
                    </div>
                </div>
